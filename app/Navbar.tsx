...
export const Navbar = () => {
  return (
    <nav className="fixed top-0 w-full z-50 bg-luxuryBlack/95 backdrop-blur-sm border-b border-gold/10">
      <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
        <Link href="/" className="font-serif text-2xl text-gold tracking-[0.4em] hover:opacity-80 transition-opacity">
          SURA
        </Link>

        <div className="hidden md:flex items-center gap-12 text-[10px] uppercase tracking-[0.3em] text-white/90">
